...
class Point (db.Model):
    ...
    nearby = db.relationship('Point', secondary=nearby_point, backref='points',cascade='all, delete, delete-orphan,save-update')
    images = db.relationship('Image', secondary=PointHasImage,
                             lazy="subquery", backref=db.backref('point', lazy=True), cascade='all, delete, delete-orphan,save-update')
