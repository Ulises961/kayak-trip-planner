...
Revision ID: a19441b232c7
Revises: 
Create Date: 2023-06-28 22:06:13.002889
...
def downgrade() -> None:
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('point_id_seq'::regclass)"), autoincrement=True, nullable=False),
